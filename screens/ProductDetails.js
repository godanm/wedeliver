...
class ProductDetails extends React.Component {
  ...
  fetchData = async () => {
    ...
    let itemslist = [];
    var temp = {
      currentitem: this.props.navigation.state.params.productDetails,
      itemId: this.props.navigation.state.params.productDetails.itemId
    };
    itemslist.push(this.props.navigation.state.params.productDetails)
