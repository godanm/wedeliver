...
class ActivityDetails extends React.Component {
    ...
    fetchData = async () => {
        //const activityid = '-9LvHs2Rw3_WK1sM127i8';

        const { navigation:navigate } = this.props;
        const activityid = this.props.navigation.state.params.id;
        let activityref = firebase.database().ref('activities/'+activityid);
                        ...
                        >
                            <Block flex style={styles.profileCard}>
                                <Block middle style={styles.avatarContainer}>
                                    <Image
                                        source={{ uri: this.state.activitydata.thumbnail }}
                                        style={styles.avatar}
                                    />
                                </Block>
                                <Block flex>
                                    <Block middle style={styles.nameInfo}>
                                        ...
                                        <Text size={16} color="#32325D" style={{ marginTop: 10 }}>
                                            Date: {this.state.activitydata.date}
                                        </Text>
                                        <Text size={16} color="#32325D" style={{ marginTop: 10 }}>
                                            Cost: ${this.state.activitydata.cost}
                                        </Text>
                                    </Block>
